...
const Announcements = () => {
    ...
    const fetchAnnouncements = async () => {
        try {
            const data = await teacherService.getAnnouncements();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingAnnouncement) {
                await teacherService.updateAnnouncement(editingAnnouncement.id, formData);
                toast.success('Announcement updated successfully');
            } else {
                await teacherService.postAnnouncement(formData);
    ...
    return (
        <motion.div 
            className="teacher-announcements"
